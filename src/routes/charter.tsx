    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-3xl px-5 sm:px-10 lg:px-16 pt-12 sm:pt-20 lg:pt-24 pb-28">
        ...
        <p className="mt-6 body-serif text-lg sm:text-xl text-foreground/75 max-w-[42ch]">
          A quiet place to keep track of a body that doesn&rsquo;t always cooperate. For you, and
        ...
        <div className="mt-14 sm:mt-20 space-y-14 sm:space-y-20 max-w-[60ch]">
          <section className="space-y-4">
            ...
            <p className="body-serif text-foreground/75">
              Anyone living with a condition that asks for daily attention (epilepsy, migraine,
              diabetes, mental health, autoimmune, dysautonomia, long COVID, chronic pain) and the
              family members and caregivers who walk alongside them.
            </p>
            <p className="body-serif text-foreground/75">
              We&rsquo;re named after the global color for epilepsy awareness, and that&rsquo;s
              where our depth runs deepest. But Purple is condition-aware, not condition-locked.
              Whatever you&rsquo;re carrying, you&rsquo;re welcome here.
            </p>
          </section>
          <section className="space-y-4">
            <h2 className="font-serif text-2xl sm:text-3xl text-foreground">How it feels to use</h2>
            <p className="body-serif text-foreground/75">
              Write a sentence. Speak a thought. Snap a photo of a prescription bottle. Purple
              listens, remembers, and quietly notices the patterns over time. No forms to fill out.
              No streaks to keep. No guilt if you put it down for a week.
            </p>
            <p className="body-serif text-foreground/75">
          ...
          <section className="space-y-4">
            ...
            <ul className="space-y-4 body-serif text-foreground/75">
              ...
              <li>
                <strong className="text-foreground">Your story is yours.</strong> Export it whenever
                you want. Delete it whenever you want. We&rsquo;ll never sell it, rent it, or hand
                it to brokers.
              </li>
              <li>
                <strong className="text-foreground">Conversation first.</strong> Health
                shouldn&rsquo;t feel like paperwork.
              </li>
              <li>
                <strong className="text-foreground">Not a medical device.</strong> Purple supports
                you and your clinician. It doesn&rsquo;t replace either of you.
              </li>
            </ul>
          </section>
          <section className="space-y-4">
            ...
            <ul className="space-y-4 body-serif text-foreground/75">
              ...
              <li>
                Paywalling the heart of Purple: journaling, medications, or sharing with the people
                who help you.
              </li>
          ...
          <section className="space-y-4 border-t border-border pt-12">
            ...
            <p className="body-serif text-foreground/75">
              Calm. Quiet. Respectful of your energy. If a feature can&rsquo;t be built within these
              promises, we don&rsquo;t ship it.
            </p>
