        ...
        <div className="mt-14 sm:mt-20 space-y-14 sm:space-y-20 max-w-[60ch]">
          <section className="space-y-4">
            ...
            <p className="body-serif text-foreground/75">
              Only what you put in or explicitly connect: your journal entries (text, voice
              transcripts, photos), medications and doses, seizures and other events, biometrics
              from devices you choose to link (Oura, WHOOP, Apple Health), and basic account info
              (email, optional name, region, preferred language).
            </p>
            <p className="body-serif text-foreground/75">
              We don&rsquo;t track you across the web. There are no third-party advertising or
              analytics trackers in Purple: no Google Analytics, no pixels, no fingerprinting.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="body-serif text-foreground/75">
              Purple uses language models to help you write, transcribe voice notes, extract
              structured details from your entries, and answer questions about your own data.
              Requests are made on your behalf to model providers via a secured gateway. Your
              content is sent only to fulfill that request. It is not used to train third-party
              models, and we do not train models on your data.
            </p>
            <p className="body-serif text-foreground/75">
          ...
          <section className="space-y-4">
            ...
            <p className="body-serif text-foreground/75">
              By default, only you. Caregivers and family members you invite get read-only access to
              the scopes you choose. If a caregiver tries to write on your behalf, you get a notice
              and the change waits for your approval.
            </p>
            <p className="body-serif text-foreground/75">
          ...
          <section className="space-y-4">
            ...
            <p className="body-serif text-foreground/75">
              On managed cloud infrastructure (Supabase / PostgreSQL), encrypted in transit and at
              rest. Uploaded files (voice clips, photos, reports) live in private storage buckets
              and are served through short-lived signed URLs, never public links.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="body-serif text-foreground/75">
              Open Settings &rarr; Data to export everything as JSON, or to delete your account.
              Deletion removes your journal, medications, biometrics, devices, sharing
              relationships, and uploaded files. Backups are purged on a rolling schedule.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="body-serif text-foreground/75">
              Purple is not directed at children under 13. Parents and caregivers may use Purple to
              track a minor&rsquo;s health on their own account, but accounts must be created and
              managed by an adult.
            </p>
          </section>
