...
export const Route = createFileRoute("/community/resources")({
  head: () =>
    marketingHead({
      ...
      description:
        "Curated resources for people living with epilepsy and their care partners.",
      ogTitle: "Resources · Purple Community",
      ogDescription: "Curated links for people living with epilepsy and their care partners.",
    }),
