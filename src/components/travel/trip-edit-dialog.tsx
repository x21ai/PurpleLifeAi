...
import { ItineraryEditor, legsAreChronological, type LegDraft } from "./itinerary-editor";
...
export function TripEditDialog({ trip, homeTz, onOpenChange, onSaved }: TripEditDialogProps) {
  ...
  React.useEffect(() => {
    ...
    setStrategy((trip.shift_strategy ?? "snap") as "snap" | "gradual" | "home");
    ...
    <Dialog open={!!trip} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[88vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Changes to dates, timezone, strategy, or legs may need a fresh dose schedule, you'll be
            asked before anything is replaced.
          </DialogDescription>
        </DialogHeader>
        <div className="flex-1 overflow-y-auto -mx-6 px-6 space-y-4 pb-2">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-1.5">
              ...
              >
                {[destinationTz, ...COMMON_TZS.filter((tz) => tz !== destinationTz)].map((tz) => (
