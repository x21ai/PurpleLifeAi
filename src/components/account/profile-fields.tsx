...
export function ProfileFields() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <p className="text-[15px] text-foreground">Full name</p>
      ...
      <div className="border-t sheet-divider pt-6">
        <p className="text-[15px] text-foreground">Phone number</p>
        ...
        <div className="mt-3">
          <Input
            ...
            inputMode="tel"
            className="bg-foreground/[0.04] border-foreground/10 text-foreground placeholder:text-foreground/30 w-full"
          />
      ...
      <div className="border-t sheet-divider pt-6">
        <p className="text-[15px] text-foreground">Gender</p>
        <p className="mt-1 text-[13px] sheet-muted">Optional. Shown to people you share with.</p>
        <div className="mt-3">
          <div className="space-y-2">
            <Select value={gender} onValueChange={setGender} disabled={loading}>
              <SelectTrigger className="bg-foreground/[0.04] border-foreground/10 text-foreground">
