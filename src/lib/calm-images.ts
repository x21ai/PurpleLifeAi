...
export const homeImages = {
  hero: asset(
    homeHero,
    "Soft mountain ridge under a violet dawn sky, mist settling in the valley below.",
  ),
  mugWindow: asset(
    homeMugWindow,
    "Two hands cradling a warm ceramic mug at a sunlit kitchen window in early morning light.",
  ),
  nightstandNotebook: asset(
    homeNightstandNotebook,
    "A small notebook and pen resting on a wooden nightstand beside a low lamp, late evening.",
  ),
  shoulderHand: asset(
    homeShoulderHand,
    "A caregiver's hand resting gently on another person's shoulder, soft window light behind.",
  ),
} as const;
...
export const featuresImages = {
  hero: asset(
    featuresHero,
    "A wide, misty mountain valley at first light, layers of fog drifting between distant ridges.",
  ),
  phoneTyping: asset(
    featuresPhoneTyping,
    "Hands typing a quiet thought into a phone on a warm wooden table, evening light.",
  ),
  pillOrganizer: asset(
    featuresPillOrganizer,
    "A weekly pill organizer beside a glass of water on a wooden surface, late afternoon light.",
  ),
  handOnShoulder: asset(
    featuresHandOnShoulder,
    "A caregiver's hand resting on a loved one's shoulder, soft natural light from a nearby window.",
  ),
} as const;
...
export const pricingImages = {
  hero: asset(
    pricingHero,
    "A calm coastline wrapped in pale fog, the horizon dissolving into the sea.",
  ),
  pillTray: asset(
    pricingPillTray,
    "An open pill tray on a worn wooden table near a window, soft late-afternoon light spilling across.",
  ),
} as const;
...
export const aboutImages = {
  hero: asset(
    aboutHero,
    "Quiet rolling hills at twilight, low purple haze blanketing the distant fields.",
  ),
  bedsideLamp: asset(
    aboutBedsideLamp,
    "A person seated on the edge of a bed at dusk, holding a phone, lamp glow behind them.",
  ),
  armAround: asset(
    aboutArmAround,
    "Two people side by side, one arm around the other's shoulders, watching the day end together.",
  ),
} as const;
...
export const communityImages = {
  hero: asset(
    communityHero,
    "A slow river curving through autumn grasses at golden hour, mountains on the horizon.",
  ),
  walkingPath: asset(
    communityWalkingPath,
    "A person walking down a grass path at golden hour, tall meadow grass on either side.",
  ),
} as const;
...
export const trustImages = {
  hero: asset(
    trustHero,
    "First light filtering through a quiet pine forest, low mist drifting between the trunks.",
  ),
} as const;

export const contactImages = {
  hero: asset(contactHero, "An utterly still lake at first light, mirroring the soft pastel sky."),
  handwrittenNote: asset(
    contactHandwrittenNote,
    "An open notebook with a handwritten note and a fountain pen resting beside it on a wooden desk.",
  ),
} as const;
...
export const signInImages = {
  hero: asset(
    signInHero,
    "A dark coastal headland at deep blue dusk, a small offshore rock silhouetted against fading sky and sea.",
  ),
} as const;
