        ...
        <main className="min-h-dvh flex flex-col max-md:pb-[5.5rem] md:max-lg:pl-16 md:pb-0 lg:pl-64">
          ...
          <div className="grow basis-[0%]">
            <div className="w-full max-w-screen-md mx-auto pb-32 max-md:pt-8 max-md:px-5 md:max-lg:px-10 md:pt-12 lg:px-16">
              <p className="text-ploy-accent-secondary-500 leading-none font-semibold text-xs tracking-widest uppercase label-eyebrow">
                {"Plan"}
              </p>
              ...
              <p className="text-ploy-text-primary/60 leading-normal text-base mt-2">
                {"Protocol actions and condition-ranked recommendations."}
              </p>
              <div
                role="tablist"
                aria-label="Plan sections"
                className="bg-ploy-neutral-primary-s3/50 inline-flex mt-5 p-1 rounded-full"
              >
                <button
                  type="button"
                  role="tab"
                  style={{ fontVariationSettings: "inherit" }}
                  className="bg-[oklab(0.684385_0.0764743_-0.0919314_/_0.2)] text-ploy-text-primary leading-snug font-medium text-sm min-h-10 block transition px-4 py-2 rounded-full"
                  data-ploy-component-type="button"
                  data-ploy-component-variant="primary"
                >
                  {"Protocol"}
