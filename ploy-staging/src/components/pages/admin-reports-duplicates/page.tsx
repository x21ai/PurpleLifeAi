          ...
          <div className="grow basis-[0%]">
            <div className="max-w-6xl mx-auto pt-8 pb-24 max-md:px-4 md:max-lg:px-6 lg:px-10">
              ...
              <div className="mt-8">
                <div>
                  <div className="mb-6">
                    <h1 className="font-heading leading-snug [font-weight:inherit] text-2xl">
                      {"Duplicate reports"}
                    </h1>
                    <p className="text-ploy-neutral-inverse-600 leading-snug text-sm mt-1">
                      {
                        "Reports grouped by user, date, and content hash. Keep one, mark the rest as duplicates, exclude a single report from trends, or restore. Nothing is deleted."
                      }
                    </p>
                  </div>
                  <p className="text-ploy-neutral-inverse-600 leading-snug text-sm">
                    {"No suspected duplicate groups found."}
                  </p>
                </div>
              </div>
            </div>
