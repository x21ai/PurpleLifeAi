...
export default function Page() {
  return (
    <>
      <HeroSection />
      <div className="font-button bg-ploy-background-primary text-ploy-text-primary min-h-dvh">
          ...
          <div className="grow basis-[0%]">
            <div className="max-w-6xl mx-auto pt-8 pb-24 max-md:px-4 md:max-lg:px-6 lg:px-10">
              ...
              <nav className="flex overflow-x-auto gap-1 mt-4 -mx-1 pb-2">
                <a
                  href="/admin"
                  className="text-nowrap bg-ploy-button-secondary-background text-ploy-button-secondary-text leading-snug text-sm whitespace-nowrap flex items-center gap-2 transition px-4 py-2 rounded-full hover:bg-ploy-neutral-primary-s3/70"
                  data-ploy-component-type="button"
                ...
                <a
                  href="/admin/billing"
                  className="text-nowrap bg-[rgb(250,250,252)] text-ploy-button-primary-text leading-snug text-sm whitespace-nowrap flex items-center gap-2 transition px-4 py-2 rounded-full"
                  data-ploy-component-type="button"
                  data-ploy-component-variant="primary"
                >
                  <PageIcon18 />
                ...
                <div>
                  <header className="mb-10">
                    ...
                    <p className="text-ploy-neutral-inverse-600 mt-2">
                      {"Manage Pro tier access and subscriptions."}
                    </p>
                  </header>
                  <section className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary mb-10 p-6 rounded-3xl border">
                    <p className="text-ploy-neutral-inverse-600 leading-snug text-xs tracking-[0.6px] uppercase">
                      {"Stripe status"}
                    </p>
                    <div className="grid gap-3 mt-3 sm:grid-cols-2 md:grid-cols-[repeat(2,minmax(0px,1fr))]">
                      <div className="leading-snug text-sm flex items-center gap-2">
                        <PageIcon27 />
                        <span className="block">Secret key:</span>
                        <span className="text-ploy-accent-primary-500 block">
                          {"Not set"}
                        </span>
                      </div>
                      <div className="leading-snug text-sm flex items-center gap-2">
                    ...
                    <p className="text-ploy-accent-primary-500 leading-snug text-xs inline-flex items-center gap-1.5 mt-4">
                      <PageIcon28 />
                      {
                    ...
                    <div className="flex justify-between items-start gap-4">
                      <div>
                        ...
                        <p className="text-ploy-neutral-inverse-600 leading-snug text-sm max-w-[36.1856rem] mt-1">
                          {
                            "While this is on, every signed-in user (including new sign-ups) gets full Pro access automatically. Paywalls and the Upgrade button stay hidden."
                          }
                        </p>
                      </div>
                      <button
                        type="button"
                        style={{ fontVariationSettings: "inherit" }}
                        className="[color:inherit] bg-ploy-neutral-primary-s3 [font-weight:inherit] w-12 h-7 flex shrink-0 items-center transition p-0 rounded-full"
                      >
                        <span className="[translate:2px] bg-ploy-background-inverse w-6 h-6 block transition rounded-full text-ploy-text-inverse" />
                      </button>
                    </div>
                  </section>
                  <section className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary mb-10 p-6 rounded-3xl border">
                    ...
                    <div className="grid gap-2 mt-5 sm:grid-cols-[1fr_120px_auto] md:grid-cols-[1fr_120px_auto]">
                      <input
                        ...
                        className="border-solid border-ploy-neutral-primary-s3 [color:inherit] bg-ploy-neutral-primary-s3 leading-snug [font-weight:inherit] text-sm block px-4 py-2 rounded-[1.25rem] overflow-clip border"
                      />
                      <input
                        min="1"
                        max="120"
                      ...
                      <button
                        ...
                        disabled={true}
                        style={{ fontVariationSettings: "inherit" }}
                        className="bg-ploy-button-primary-background text-ploy-button-secondary-text leading-snug font-semibold text-sm block opacity-60 px-5 py-2 rounded-[1.25rem]"
                        data-ploy-component-type="button"
                        data-ploy-component-variant="primary"
                      >
                        {"Grant Pro"}
                  ...
                  <section className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary p-6 rounded-3xl border">
                    <h2
                      style={{
                        fontFamily:
                          "Georgia, 'Iowan Old Style', 'Palatino Linotype', Palatino, serif",
