      ...
      <div className="font-heading bg-ploy-background-primary text-ploy-text-primary min-h-dvh">
        ...
        <main className="min-h-dvh flex flex-col max-md:pb-[5.5rem] md:max-lg:pl-16 md:pb-0 lg:pl-64">
          ...
          <div className="grow basis-[0%]">
            <div className="max-w-2xl mx-auto pb-24 max-md:pt-10 max-md:px-5 md:pt-16 md:px-10">
              <a
                href="/settings"
                className="text-ploy-neutral-inverse-600 leading-snug text-sm inline-flex items-center gap-1 hover:text-ploy-text-primary"
              >
                <PageIcon15 />
                {"Settings"}
              </a>
              ...
              <div className="mt-10">
                <section className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary mb-6 p-5 rounded-3xl border">
                  <h2
                    style={{
                      fontFamily:
                        "Georgia, 'Iowan Old Style', 'Palatino Linotype', Palatino, serif",
                    }}
                    className="text-ploy-text-primary leading-normal [font-weight:inherit] text-lg flex items-center gap-2"
                  >
                    <span className="bg-ploy-neutral-primary-s3 text-ploy-text-primary w-6 h-6 grid items-center justify-items-center rounded-full">
                      <PageIcon16 />
                    </span>
                    {" What PurpleLife sees"}
                  </h2>
                  <p className="text-ploy-text-primary/80 leading-relaxed text-base mt-2">
                    {
                      "When you ask a question, PurpleLife reads the last 7 days of biometrics, 14 days of journal entries, 90 days of seizure events, your current medications, and the latest risk forecast. Nothing else."
                    }
                  </p>
                </section>
                <section className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary mb-6 p-5 rounded-3xl border">
                  ...
                  <p className="text-ploy-text-primary/80 leading-relaxed text-base mt-2">
                    {
                      "Every night, a small job looks across 8 signals, sleep, HRV, temperature, activity, missed doses, mood, location, and seizure history, for repeating combinations. New patterns surface in "
                    }
                    <a
                      href="/insights"
                      className="[color:inherit] ml-1"
                    >
                      {"Patterns"}
                    </a>
                    {"."}
                ...
                <section className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary mb-6 p-5 rounded-3xl border">
                  ...
                  >
                    ...
                    {" When PurpleLife proposes an action"}
                  </h2>
                  <p className="text-ploy-text-primary/80 leading-relaxed text-base mt-2">
                    {
                      "If PurpleLife wants to add a medication, log a seizure, or change a setting on your behalf, it shows a Confirm card first. Nothing is written until you tap Confirm."
                    }
                  </p>
                </section>
                <section className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary p-5 rounded-3xl border">
                  <h2
                    style={{
                      fontFamily:
                        "Georgia, 'Iowan Old Style', 'Palatino Linotype', Palatino, serif",
                  ...
                  <p className="text-ploy-text-primary/80 leading-relaxed text-base mt-2">
                    {
                      "Your data lives in your account. PurpleLife never trains models on it, never shares it with anyone, and you can export or delete everything from"
                    }{" "}
                    <a
                      href="/settings"
