          ...
          <div className="grow basis-[0%]">
            <div className="max-w-screen-md mx-auto pb-24 max-md:pt-12 max-md:px-5 md:max-lg:pt-20 md:max-lg:px-10 lg:pt-24 lg:px-16">
              ...
              <section className="mt-10">
                <div className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary text-center p-8 rounded-3xl border">
                  <p
                    style={{
                      fontFamily:
                        "Georgia, 'Iowan Old Style', 'Palatino Linotype', Palatino, serif",
                    }}
                    className="text-ploy-text-primary leading-snug text-xl"
                  >
