      ...
      <div className="font-heading bg-ploy-background-primary text-ploy-text-primary min-h-dvh">
          ...
          >
            ...
            <div className="mb-0.5">
              ...
              <div className="border-solid border-ploy-neutral-primary-s3/60 ml-3 mt-0.5 mb-1.5 pl-3 border-l hidden min-[1024px]:block">
                ...
                >
                  <PageIcon11 />
                  <span className="block">Apple Health import</span>
                </a>
                <a
        ...
        <main className="min-h-dvh flex flex-col max-md:pb-[5.5rem] md:max-lg:pl-16 md:pb-0 lg:pl-64">
          ...
          <div className="grow basis-[0%]">
            <div className="max-w-screen-md mx-auto pb-24 max-md:pt-10 max-md:px-5 md:max-lg:px-10 md:pt-16 lg:px-16">
              <a
                href="/settings"
                className="text-ploy-neutral-inverse-600 leading-snug text-xs inline-flex items-center gap-1 hover:text-ploy-text-primary"
              >
                <PageIcon18 />
                {"Settings"}
              </a>
              <h1 className="font-heading text-ploy-text-primary leading-none font-semibold tracking-[-0.02em] mt-4 app-hero-title max-md:text-3xl max-md:leading-none md:text-4xl md:leading-none">
                {"I'm Traveling"}
              </h1>
              <p className="text-ploy-text-primary/75 max-w-[37.5rem] mt-3">
                {
                  "Tell PurpleLife your itinerary. We rebuild your medication schedule across flights and layovers, choosing each dose time based on the timezone you're actually in."
                }
              </p>
              <div className="mt-6">
                <a
                  href="#plan-a-trip"
                  className="bg-ploy-button-primary-background text-ploy-button-primary-text leading-snug font-medium text-sm inline-flex items-center px-4 py-2 rounded-full hover:opacity-90"
                  data-ploy-component-type="button"
                  data-ploy-component-variant="primary"
                >
                  <PageIcon19 />
              ...
              <section className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary mt-8 rounded-3xl max-md:p-5 md:p-6 border">
                ...
                <div className="flex flex-wrap items-center gap-2 mt-4">
                  <select className="text-nowrap border-solid border-ploy-neutral-primary-s3 bg-ploy-background-primary text-ploy-text-primary text-sm whitespace-pre items-center cursor-default px-3 py-2 rounded-2xl border">
              ...
              <section
                id="plan-a-trip"
                className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary mt-6 rounded-3xl max-md:p-5 md:p-6 border"
              >
                <h2
                  style={{
                    fontFamily:
                ...
                <div className="grid gap-3 mt-4 sm:grid-cols-2 md:grid-cols-[repeat(2,minmax(0px,1fr))]">
                  <div className="md:col-start-[span_2] md:col-end-[span_2]">
                    <label className="leading-none font-medium text-sm mb-1.5">
                      {"Label (optional)"}
                    </label>
                    <input
                      id="trip-label"
                      ...
                      style={{ fontVariationSettings: "inherit" }}
                      className="border-solid border-ploy-neutral-primary-s3 [color:inherit] [font-weight:inherit] text-sm w-full h-[calc((.25rem)_*_9)] flex shadow-sm transition-colors px-3 py-1 rounded-[0.875rem] border-input md:leading-snug overflow-clip border"
                    />
                  </div>
                  <div>
                    <label className="leading-none font-medium text-sm mb-1.5">
                      {"Final destination timezone"}
                    </label>{" "}
                    <select
                      id="trip-dest"
                      className="text-nowrap border-solid border-ploy-neutral-primary-s3 bg-ploy-background-primary text-ploy-text-primary text-sm whitespace-pre w-full items-center cursor-default px-3 py-2 rounded-2xl border"
                    >
                      <option value="America/New_York">America/New_York</option>
                      <option value="America/Chicago">America/Chicago</option>
                      <option value="America/Denver">America/Denver</option>
                ...
                <div className="mt-5">
                  <div>
                    <div className="flex justify-between items-center">
                      <h3 className="text-ploy-text-primary leading-snug font-medium text-sm">
                        {"Legs"}
                      </h3>
                      <button
                        type="button"
                        style={{ fontVariationSettings: "inherit" }}
                        className="text-nowrap border-solid border-ploy-neutral-primary-s3 [color:inherit] bg-ploy-background-primary leading-snug font-medium text-xs whitespace-nowrap h-7 flex justify-center items-center gap-2 shadow-sm cursor-pointer transition-colors px-3 py-0 rounded-full [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border-input hover:bg-[#b084d1] hover:text-ploy-text-inverse border"
                      >
                        <PageIcon20 />
                        {"Add leg"}
                      </button>
                    </div>
                    <p className="text-ploy-neutral-inverse-600 leading-snug text-xs mt-2">
                      {
                        "Optional. Add a leg for each flight or layover, e.g. arrival in Dubai at 22:10 local, then Hong Kong at 14:25 local. Without legs, PurpleLife uses your final destination from departure."
                      }
                    </p>
                  </div>
                </div>
