        ...
        <main className="min-h-dvh flex flex-col max-md:pb-[5.5rem] md:max-lg:pl-16 md:pb-0 lg:pl-64">
          ...
          <div className="grow basis-[0%]">
            <div className="max-w-screen-md mx-auto px-4 py-6">
              ...
              <section className="border-solid border-ploy-text-primary/10 bg-ploy-background-secondary/60 mb-8 p-5 rounded-3xl border">
                <div className="mb-4">
                  <label className="text-ploy-neutral-inverse-600 leading-snug font-medium text-xs tracking-wide uppercase">
                    {"Date range"}
                  </label>
                  ...
                  <div className="grid gap-3 grid-cols-[repeat(2,minmax(0px,1fr))] mt-3">
                    <div>
                      <label className="leading-snug font-medium text-xs">
                        {"From"}
                      </label>{" "}
                      <button
                        id="from"
                        ...
                        data-state="closed"
                        style={{ fontVariationSettings: "inherit" }}
                        className="text-nowrap border-solid border-ploy-neutral-primary-s3 bg-ploy-background-primary text-ploy-text-primary leading-snug text-sm whitespace-nowrap w-full h-9 inline-flex justify-start items-center gap-2 shadow-sm cursor-pointer transition-colors px-4 py-2 rounded-[0.875rem] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border-input hover:bg-ploy-background-accent-secondary hover:text-ploy-text-inverse border"
                      >
                        <PageIcon17 />
                        {"Jun 17, 2026"}
                      </button>
                ...
                <div className="mb-4">
                  ...
                  <div className="leading-snug text-sm grid gap-[0.5rem_normal] grid-cols-[repeat(2,minmax(0px,1fr))] mt-2">
                    <label className="capitalize flex items-center gap-2">
                      <button
                        ...
                        value="on"
                        style={{ fontVariationSettings: "inherit" }}
                        className="border-solid [color:inherit] bg-[rgb(250,250,252)] [font-weight:inherit] w-9 h-5 flex shrink-0 items-center shadow-sm cursor-pointer transition-colors p-0 rounded-full border-2 peer data-[state=unchecked]:bg-input border-transparent"
                        data-ploy-component-type="button"
                        data-ploy-component-variant="primary"
                      >
                        <span
              ...
              <section className="mb-8">
                <h2 className="text-ploy-text-primary leading-tight font-semibold text-lg tracking-[-0.01em] mb-3 app-section-title">
                  {"Your reports"}
                </h2>
              ...
              <div className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary rounded-[1.75rem] max-md:p-6 md:p-8 border">
                <div className="bg-ploy-background-accent-secondary/10 text-ploy-accent-secondary-500 text-xs tracking-wide uppercase inline-flex items-center gap-2 px-3 py-1 rounded-full">
                  <PageIcon19 />
                  {"PurpleLife Pro"}
                </div>
                <h3
                ...
                >
                  {"Sharing & scheduled reports are a Pro feature"}
                </h3>
                <p className="text-ploy-text-primary/70 leading-snug text-sm max-w-[36.1856rem] mt-2">
                  {
                    "Share medical reports with a clinician or family member, and schedule recurring sends."
                  }
                </p>
                <a
                  href="/account"
                  className="bg-ploy-button-primary-background text-ploy-button-secondary-text leading-snug font-semibold text-sm inline-flex justify-center items-center mt-5 px-5 py-2.5 rounded-full hover:opacity-90"
                  data-ploy-component-type="button"
                  data-ploy-component-variant="primary"
                >
                  {"Upgrade to Pro"}
