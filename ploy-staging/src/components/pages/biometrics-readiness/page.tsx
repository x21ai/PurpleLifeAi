                    ...
                    <ul className="mb-0 pl-0">
                      <li className="mb-3">
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {"How has my readiness been trending?"}
                          </span>
                          <PageIcon23 />
                        </button>
                      </li>
                      <li className="mb-3">
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {"What was happening on days my readiness dropped?"}
                          </span>
                          <PageIcon23 />
                        </button>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {
                              "What does the research say about readiness and seizures?"
                            }
                          </span>
                          <PageIcon23 />
                        </button>
