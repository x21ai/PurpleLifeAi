              ...
              <div className="max-w-screen-md mx-auto pt-6 pb-32 max-md:px-5 md:px-8">
                ...
                <div className="mt-5">
                  ...
                  <div className="leading-snug text-sm flex flex-wrap items-baseline gap-3 mt-3">
                    ...
                    <span className="text-ploy-text-primary/60 block">
                      {"· vs "}
                      <span className="text-ploy-text-primary">74</span>
                    </span>
                  ...
                  <section className="mt-10">
                    ...
                    <p className="text-ploy-text-primary/60 leading-snug text-sm mt-3">
                      {"Below 65 for two nights in a row is the soft alarm."}
                    </p>
                  </section>
                  <section className="mt-10">
                    ...
                    <ul className="mb-0 pl-0">
                      <li className="mb-3">
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {"How has my sleep score been trending?"}
                          </span>
                          <PageIcon23 />
                        </button>
                      </li>
                      <li className="mb-3">
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {
                              "What was happening on days my sleep score dropped?"
                            }
                          </span>
                          <PageIcon23 />
                        </button>
                      ...
                      <li>
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {
                              "What does the research say about sleep score and seizures?"
                            }
                          </span>
                          <PageIcon23 />
                        </button>
