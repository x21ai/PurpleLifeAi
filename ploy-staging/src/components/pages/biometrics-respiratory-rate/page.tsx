                ...
                <div className="mt-5">
                  ...
                  <section className="mt-10">
                    ...
                    <p className="text-ploy-text-primary/60 leading-snug text-sm mt-3">
                      {"Most adults sit between 12 and 20 while asleep."}
                    </p>
                  </section>
                  <section className="mt-10">
                    ...
                    <ul className="mb-0 pl-0">
                      <li className="mb-3">
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {"How has my resp rate been trending?"}
                          </span>
                          <PageIcon23 />
                        </button>
                      </li>
                      <li className="mb-3">
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {"What was happening on days my resp rate dropped?"}
                          </span>
                          <PageIcon23 />
                        </button>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {
                              "What does the research say about resp rate and seizures?"
                            }
                          </span>
                          <PageIcon23 />
                        </button>
