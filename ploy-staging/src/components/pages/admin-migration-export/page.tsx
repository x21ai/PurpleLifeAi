              ...
              <div className="mt-8">
                <div className="max-w-2xl mx-auto p-6">
                  <header className="mb-6">
                    <h1 className="leading-snug font-semibold text-2xl">
                      {"Migration export"}
                    </h1>
                    <p className="text-ploy-neutral-inverse-600 leading-snug text-sm mt-1">
                      {
                        "One-shot exports for moving PurpleLife off Lovable Cloud. Super-admin only. Both files download to your machine. Signed storage URLs are valid for 7 days; re-run if your migration script does not finish in that window."
                      }
                    </p>
                  </header>
                  <section className="border-solid border-ploy-neutral-primary-s3 mb-6 p-4 rounded-2xl border">
                    <h2 className="font-medium mb-3">1. Auth users</h2>
                    <p className="text-ploy-neutral-inverse-600 leading-snug text-sm mb-3">
                      {"Exports every" + " "}
                      <code
                        style={{
                          fontFamily:
                      ...
                      {
                        "row (id, email, metadata) so the import script can recreate them in the new project with the same UUIDs."
                      }
                    </p>
                    <button
                      style={{ fontVariationSettings: "inherit" }}
                      className="bg-ploy-button-primary-background text-ploy-button-secondary-text leading-snug [font-weight:inherit] text-sm px-3 py-1.5 rounded-[0.875rem]"
                      data-ploy-component-type="button"
                      data-ploy-component-variant="primary"
                    >
                      {"Download auth-users.json"}
                    </button>
                  </section>
                  <section className="border-solid border-ploy-neutral-primary-s3 mb-6 p-4 rounded-2xl border">
                    <h2 className="font-medium mb-3">2. Storage manifest</h2>
                    <p className="text-ploy-neutral-inverse-600 leading-snug text-sm mb-3">
                      {
                        "Lists every object in journal-media, reports, medical-reports, care-chat-attachments, and dna-uploads, and signs each one for 7 days. The local migrate-storage script streams these to the new project."
                      }
                    </p>
                    <button
                      style={{ fontVariationSettings: "inherit" }}
                      ...
                      data-ploy-component-variant="primary"
                    >
                      {"Download storage-manifest.json"}
                    </button>
                  </section>
                  <section className="border-solid border-ploy-neutral-primary-s3 p-4 rounded-2xl border">
                    <h2 className="font-medium mb-3">
                      {"3. All public tables (CSV zip)"}
                    </h2>
                    <p className="text-ploy-neutral-inverse-600 leading-snug text-sm mb-3">
                      {"Dumps every row of every public table to CSV using the service role (RLS bypassed). Includes" +
                        " "}
                      <code
                        style={{
                          fontFamily:
                      ...
                      {
                        "for the cutover verifier. No database password required."
                      }
                    </p>
                    <button
                      style={{ fontVariationSettings: "inherit" }}
