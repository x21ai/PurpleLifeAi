      ...
      <div className="font-heading bg-ploy-background-primary text-ploy-text-primary min-h-dvh">
        ...
        <main className="min-h-dvh flex flex-col max-md:pb-[5.5rem] md:max-lg:pl-16 md:pb-0 lg:pl-64">
          ...
          <div className="grow basis-[0%]">
            <div className="max-w-screen-md mx-auto pb-24 max-md:pt-10 max-md:px-5 md:max-lg:pt-16 md:max-lg:px-10 lg:pt-20 lg:px-16">
              <div className="flex justify-between items-center gap-3">
                ...
                <a
                  href="/meds?add=past"
                  className="border-solid border-[rgb(37,32,47)] bg-ploy-button-secondary-background text-ploy-button-secondary-text leading-snug text-xs flex items-center gap-1 transition-colors px-3 py-1.5 rounded-full hover:bg-ploy-neutral-primary-s3/40 border"
                  data-ploy-component-type="button"
                  data-ploy-component-variant="secondary"
                >
                  <PageIcon21 />
                  {"Add a past medication"}
                </a>
              </div>
              ...
              <p className="text-ploy-neutral-inverse-600 leading-snug text-sm mt-10">
                {"Loading…"}
              </p>
            </div>
          </div>
