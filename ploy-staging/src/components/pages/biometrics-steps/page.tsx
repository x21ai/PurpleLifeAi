                ...
                <div className="mt-5">
                  ...
                  <div className="flex justify-between items-center gap-3 mt-3">
                    <p className="text-ploy-text-primary/60 leading-snug text-xs">
                      {"Your 30-day baseline · 4,482.852"}
                    </p>
                  ...
                  <section className="mt-10">
                    ...
                    <p className="text-ploy-text-primary/60 leading-snug text-sm mt-3">
                      {"A 50%+ drop from your usual is worth noticing."}
                    </p>
                  </section>
                  <section className="mt-10">
                    ...
                    <ul className="mb-0 pl-0">
                      <li className="mb-3">
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {"How has my steps been trending?"}
                          </span>
                          <PageIcon23 />
                        </button>
                      </li>
                      <li className="mb-3">
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {"What was happening on days my steps dropped?"}
                          </span>
                          <PageIcon23 />
                        </button>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          <span className="text-ploy-text-primary leading-snug text-sm block grow basis-[0%]">
                            {
                              "What does the research say about steps and seizures?"
                            }
                          </span>
                          <PageIcon23 />
                        </button>
