        ...
        <main className="min-h-dvh flex flex-col max-md:pb-[5.5rem] md:max-lg:pl-16 md:pb-0 lg:pl-64">
          ...
          <div className="grow basis-[0%]">
            <div className="max-w-screen-md mx-auto pb-24 max-md:pt-12 max-md:px-5 md:max-lg:pt-20 md:max-lg:px-10 lg:pt-24 lg:px-16">
              ...
              <p className="text-ploy-neutral-inverse-600 leading-snug text-sm max-w-xl mt-3">
                {"Manage who you care for and who cares for you."}
              </p>
              <section className="mt-12">
                <div className="flex justify-between items-end gap-3">
                  <div>
                    <h2 className="text-ploy-text-primary leading-tight font-semibold text-lg tracking-[-0.01em] app-section-title">
                      {"People you care for"}
                    </h2>
                ...
                <p className="text-ploy-accent-secondary-500 leading-snug text-sm mt-6">
                  {
                    "Missing Cloudflare service configuration. Set the required bindings in the deployment environment."
                  }
                </p>
              </section>
