                  ...
                  <main>
                    <section className="border-solid border-ploy-neutral-inverse-s0/10 bg-ploy-background-primary/80 shadow-[0px_8px_32px_0px_rgba(0,0,0,0.36),0px_1px_2px_0px_rgba(0,0,0,0.24),0px_0.5px_0px_0px_inset_color-mix(in_srgb,var(--ploy-neutral-inverse)_8%,transparent),0px_0.5px_0px_0px_inset_color-mix(in_srgb,var(--ploy-neutral-inverse)_10%,transparent)] rounded-[1.75rem] sheet-card max-md:p-5 md:p-7 overflow-hidden border">
                      <p className="text-ploy-neutral-inverse-500 leading-relaxed text-sm mb-4">
                        {
                          "PurpleLife is a personal health journal. It is not a medical device and not a substitute for professional advice, diagnosis, or treatment. In an emergency, call your local emergency number."
                        }
                      </p>
                      <p className="text-ploy-neutral-inverse-500 leading-relaxed text-sm mb-4">
                        {
                      ...
                      <p className="text-ploy-neutral-inverse-500 leading-relaxed text-sm mb-4">
                        {
                          "Use PurpleLife honestly. Don’t abuse the service, attempt to break it, or upload content that isn’t yours to share. We may suspend accounts that do."
                        }
                      </p>
                      <p className="text-ploy-neutral-inverse-500 leading-relaxed text-sm mb-4">
                        {
                          "The software is provided “as is” without warranty of any kind. To the extent allowed by law, the makers of PurpleLife are not liable for damages arising from your use of it."
                        }
                      </p>
