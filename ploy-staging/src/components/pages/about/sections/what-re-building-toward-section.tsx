/**
 * @ployComponent
 * @ployComponentId about-what-re-building-toward-section
 * @ployComponentType section
 * @ployComponentPattern section
 * @ployComponentDescription Deterministic section inferred from label: What we’re building toward
 */
export default function WhatReBuildingTowardSection() {
  return (
      ...
      <div className="grid items-center lg:grid-cols-2 max-lg:gap-10 lg:gap-20">
        <div className="w-full relative rounded-[1.75rem] max-lg:aspect-[4_/_5] max-lg:max-w-[26.25rem] max-lg:mx-auto lg:aspect-[3_/_4] lg:max-w-none lg:mx-0 overflow-hidden">
          <picture>
            {" "}
            <img
              src="https://storage.googleapis.com/ployai/d109b67e-226c-43c3-b6d7-09d3b70301cd/user/99964aad-moment-about-bedside-lamp-b-dhh1r0.webp"
              width="1280"
              height="1280"
              alt="A person seated on the edge of a bed at dusk, holding a phone, lamp glow behind them."
              loading="eager"
