                ...
                <div>
                  <div className="flex flex-wrap justify-between items-end gap-4">
                    ...
                    <input
                      ...
                      style={{ fontVariationSettings: "inherit" }}
                      className="border-solid border-ploy-neutral-primary-s3 [color:inherit] bg-ploy-background-secondary leading-snug [font-weight:inherit] text-sm min-w-60 block px-4 py-2 rounded-full overflow-clip border"
                    />
                  </div>
                  <div className="flex flex-wrap gap-2 mt-4">
                    <button
                      style={{ fontVariationSettings: "inherit" }}
                      className="bg-ploy-button-primary-background text-ploy-button-secondary-text leading-snug [font-weight:inherit] text-xs capitalize block px-3 py-1.5 rounded-full"
                      data-ploy-component-type="button"
                      data-ploy-component-variant="primary"
                    >
                      {"active"}
                    ...
                    <button
                      style={{ fontVariationSettings: "inherit" }}
                      className="bg-[rgb(31,26,43)] text-ploy-text-primary leading-snug [font-weight:inherit] text-xs capitalize block px-3 py-1.5 rounded-full"
                      data-ploy-component-type="button"
                      data-ploy-component-variant="primary"
                    >
                      {"paused"}
                  ...
                  <ul className="mt-6 mb-0 pl-0 min-[768px]:hidden">
                    <p className="text-ploy-neutral-inverse-600">No users.</p>
                  </ul>
                  <div className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary overflow-x-auto mt-6 rounded-3xl min-[768px]:block max-md:hidden border">
                    <table className="leading-snug text-sm w-full">
                      <thead className="text-ploy-neutral-inverse-600 leading-snug text-xs tracking-[0.6px] uppercase text-left table-header-group">
                        <tr className="uppercase">
                          <th className="uppercase px-4 py-3">Name</th>
                          <th className="uppercase px-4 py-3">User ID</th>
                          <th className="uppercase px-4 py-3">Joined</th>
                          <th className="uppercase px-4 py-3">Community</th>
                          <th className="uppercase px-4 py-3">Status</th>
                          <th className="uppercase px-4 py-3" />
                        </tr>
                      </thead>
                      <tbody className="table-row-group">
                        <tr>
                          <td className="text-ploy-neutral-inverse-600 text-center px-4 py-8">
                            {"No users."}
                          </td>
                        </tr>
                      </tbody>
