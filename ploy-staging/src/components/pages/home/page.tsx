 ...
 * @ployComponentDescription Public PurpleLife marketing landing page that introduces the health journal and leads into the static app preview.
      ...
      <main>
          ...
          <div className="overflow-hidden rounded-[42px] bg-white p-4 shadow-xl ring-1 ring-purplelife-line md:p-6">
            <div className="rounded-[34px] bg-purplelife-canvas px-4 pb-5 pt-2 md:px-8">
              ...
              <div className="mx-auto -mt-4 max-w-md rounded-[26px] bg-white/88 p-5 text-center shadow-sm ring-1 ring-white">
                ...
                <p className="mt-2 text-sm leading-relaxed text-purplelife-muted">Nothing is added, analyzed, or shared from this preview.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="purplelife-home__cta px-5 pb-20 md:px-10 md:pb-28">
          <div className="mx-auto max-w-6xl rounded-[42px] bg-purplelife-accent px-6 py-12 text-white md:px-12 md:py-16">
            <p className="text-xs font-semibold uppercase tracking-[0.1em] text-white/70">Design review build</p>
            <div className="mt-4 flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
              <div>
                <h2 className="max-w-3xl font-heading text-4xl font-semibold leading-none tracking-[-0.05em] md:text-6xl">Explore the full PurpleLife prototype.</h2>
                <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/75">Interactions use local mock state. Production authentication, storage, uploads, billing, and health APIs are not connected.</p>
              </div>
