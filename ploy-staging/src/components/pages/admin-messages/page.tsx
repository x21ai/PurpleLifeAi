            ...
            <div className="max-w-6xl mx-auto pt-8 pb-24 max-md:px-4 md:max-lg:px-6 lg:px-10">
              ...
              <div className="mt-8">
                <div>
                  ...
                  <div className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary mt-6 p-6 rounded-3xl border">
                    <input
                      placeholder="Subject"
                      style={{ fontVariationSettings: "inherit" }}
                      className="border-solid border-ploy-neutral-primary-s3 [color:inherit] bg-ploy-background-primary [font-weight:inherit] w-full mb-3 px-4 py-2 rounded-[1.25rem] overflow-clip border"
                    />
                    <textarea
                      rows={4}
                      placeholder="Message body"
                      className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-primary whitespace-pre-wrap break-words w-full cursor-text mb-3 px-4 py-2 rounded-[1.25rem] border text-ploy-text-primary"
                    />
                    <input
                      ...
                      className="border-solid border-ploy-neutral-primary-s3 [color:inherit] bg-ploy-background-primary leading-snug [font-weight:inherit] text-sm w-full mb-3 px-4 py-2 rounded-[1.25rem] overflow-clip border"
                    />
                    <button
                      style={{ fontVariationSettings: "inherit" }}
                      className="bg-ploy-button-primary-background text-ploy-button-secondary-text [font-weight:inherit] px-5 py-2 rounded-full"
                      data-ploy-component-type="button"
                      data-ploy-component-variant="primary"
                    >
                      {"Broadcast"}
                  ...
                  <h2
                    ...
                    className="leading-snug [font-weight:inherit] text-2xl mt-10"
                  >
                    {"Recent"}
                  </h2>
