              ...
              <div className="mt-8">
                <div>
                  ...
                  <p className="text-ploy-neutral-inverse-600 mt-2">
                    {"Operational stats across the platform."}
                  </p>
                  <div className="grid gap-4 mt-8 lg:grid-cols-3 md:max-lg:grid-cols-[repeat(2,minmax(0px,1fr))]">
                    <div className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary p-6 rounded-3xl border">
                  ...
                  <h2
                    ...
                    className="leading-snug [font-weight:inherit] text-2xl mt-12"
                  >
                    {"Med reminder reliability (7 days)"}
                  </h2>
                  ...
                  <div className="grid gap-4 mt-4 lg:grid-cols-4 md:max-lg:grid-cols-[repeat(2,minmax(0px,1fr))]">
                    <div className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary p-6 rounded-3xl border">
                      <p className="text-ploy-neutral-inverse-600 leading-snug text-xs tracking-[0.6px] uppercase">
                        {"Doses scheduled"}
                      </p>
