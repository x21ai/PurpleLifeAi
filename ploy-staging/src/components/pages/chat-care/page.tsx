      ...
      <div className="font-heading bg-ploy-background-primary text-ploy-text-primary min-h-dvh">
        ...
        <main className="min-h-dvh flex flex-col max-md:pb-[5.5rem] md:max-lg:pl-16 md:pb-0 lg:pl-64">
          ...
          <div className="grow basis-[0%]">
            <div className="max-w-6xl flex flex-col mx-auto h-[calc(100dvh-4rem)] md:p-4">
              <div
                className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary flex grow basis-[0%] md:bg-card max-md:border-0 md:shadow-sm md:rounded-3xl md:border overflow-hidden"
                data-ploy-component-type="card"
                data-ploy-surface-depth="deep"
              >
                <aside className="border-solid border-ploy-neutral-primary-s3 flex flex-col max-md:w-full max-md:border-r-0 md:w-80 md:shrink-0 md:border-r">
                  <header className="border-solid border-ploy-neutral-primary-s3 flex justify-between items-center gap-2 px-4 py-3 border-b">
                    <h1 className="leading-normal font-semibold">Care chat</h1>
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        data-state="closed"
                        style={{ fontVariationSettings: "inherit" }}
                        className="text-nowrap [color:inherit] leading-snug font-medium text-xs whitespace-nowrap h-8 flex justify-center items-center gap-1.5 cursor-pointer transition-colors px-3 py-0 rounded-[0.875rem] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-[#b084d1] hover:text-ploy-text-inverse"
                      >
                        <PageIcon17 />
                        {"New"}
                      </button>
                  ...
                  <div className="overflow-y-auto grow basis-[0%]">
                    <div className="text-ploy-neutral-inverse-600 leading-snug text-sm text-center px-4 py-10">
                      <PageIcon19 />
                      {"No conversations yet."}
                      <p className="leading-snug text-xs mt-2">
                        {
                          "Open a chat from a caregiver card in Settings → Sharing, or from a person on the Caregiver page."
                        }
                      </p>
                    </div>
                ...
                <section className="bg-ploy-background-primary flex-col grow basis-[0%] min-[768px]:flex max-md:hidden text-ploy-text-primary">
                  <div className="text-ploy-neutral-inverse-600 leading-snug text-sm grow basis-[0%] justify-center items-center min-[768px]:flex max-md:hidden">
