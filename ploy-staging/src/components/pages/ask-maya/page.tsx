          ...
          <div className="w-full min-h-12 max-w-screen-md flex justify-between items-center mx-auto px-4">
            ...
            <div className="flex items-center gap-0.5">
              ...
              >
                <span
                  aria-hidden="true"
                  className="bg-ploy-background-accent-primary text-ploy-text-primary font-medium text-xs w-8 h-8 flex justify-center items-center rounded-full overflow-hidden"
                >
        ...
        <main className="min-h-dvh flex flex-col max-md:pb-[5.5rem] md:max-lg:pl-16 md:pb-0 lg:pl-64">
          ...
          <div className="grow basis-[0%]">
            <div className="w-full max-w-screen-md mx-auto pb-32 max-md:pt-8 max-md:px-5 md:max-lg:px-10 md:pt-12 lg:px-16">
              <p className="text-ploy-accent-primary-500 leading-none font-semibold text-xs tracking-widest uppercase label-eyebrow">
                {"Ask Maya"}
              </p>
              <h1 className="font-heading text-ploy-text-primary leading-none font-semibold tracking-[-0.02em] mt-3 app-hero-title max-md:text-3xl max-md:leading-none md:text-4xl md:leading-none">
                {"Good evening, there."}
              </h1>
              <div
                style={{
                  ...
                  borderLeftColor: "rgb(176, 132, 209)",
                }}
                className="border-solid bg-ploy-background-primary/80 shadow-[0px_8px_32px_0px_rgba(0,0,0,0.36),0px_1px_2px_0px_rgba(0,0,0,0.24),0px_0.5px_0px_0px_inset_color-mix(in_srgb,var(--ploy-neutral-inverse)_8%,transparent)] mt-5 rounded-[1.25rem] border-l-4 border-t border-r border-b max-md:p-4 md:p-5"
              >
                <p className="text-ploy-text-primary/75 leading-normal text-base">
                  {
                    "I know your conditions and wearable data. How's today feeling?"
                  }
                </p>
              </div>
              <div className="flex flex-wrap gap-2 mt-4">
                <button
                  type="button"
                  style={{ fontVariationSettings: "inherit" }}
                  className="border-solid border-ploy-button-primary-border/60 bg-ploy-button-secondary-background/30 text-ploy-button-secondary-text leading-snug [font-weight:inherit] text-sm text-left block transition-none px-4 py-2 rounded-full border"
                  data-ploy-component-type="button"
              ...
              <div className="border-solid border-ploy-neutral-inverse-s0/10 bg-ploy-background-primary/80 shadow-[0px_8px_32px_0px_rgba(0,0,0,0.36),0px_1px_2px_0px_rgba(0,0,0,0.24),0px_0.5px_0px_0px_inset_color-mix(in_srgb,var(--ploy-neutral-inverse)_8%,transparent)] mt-5 rounded-[1.25rem] max-md:p-4 md:p-5 border">
                <p className="text-ploy-text-primary leading-snug font-semibold text-sm">
                  {"Upload past labs"}
                </p>
                ...
                <a
                  href="/reports/new"
                  className="bg-ploy-background-accent-primary text-ploy-button-secondary-text leading-snug font-medium text-sm inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-full"
                  data-ploy-component-type="button"
                  data-ploy-component-variant="primary"
                >
                  <PageIcon15 />
              ...
              <button
                type="button"
                style={{ fontVariationSettings: "inherit" }}
                className="border-solid border-[oklab(0.684385_0.0764743_-0.0919314_/_0.4)] bg-ploy-background-accent-primary/10 text-ploy-button-secondary-text leading-snug font-medium text-sm w-full flex justify-center items-center gap-2 mt-6 px-0 py-3 rounded-full hover:bg-ploy-background-accent-primary/20 border"
                data-ploy-component-type="button"
                data-ploy-component-variant="primary"
              >
                <PageIcon16 />
            ...
            <div className="border-solid border-ploy-neutral-inverse-s0/10 bg-ploy-background-primary/90 shadow-[0px_8px_32px_0px_rgba(0,0,0,0.36),0px_1px_2px_0px_rgba(0,0,0,0.24),0px_0.5px_0px_0px_inset_color-mix(in_srgb,var(--ploy-neutral-inverse)_8%,transparent),0px_0.5px_0px_0px_inset_color-mix(in_srgb,var(--ploy-neutral-inverse)_10%,transparent),0px_8px_40px_0px_rgba(0,0,0,0.38)] rounded-[1.75rem] nav-glass-bar border">
              <div className="grid items-center grid-cols-[repeat(5,minmax(0px,1fr))]">
                ...
                <a
                  aria-label="Ask Maya"
                  href="/ask-maya"
                  className="text-ploy-accent-primary-500 text-xs min-w-11 min-h-[3.75rem] relative flex flex-col justify-center items-center gap-0.5 transition-[color,opacity] nav-glass-tab-active"
                >
                  <span aria-hidden="true" className="block nav-tab-icon-wrap">
                    <PageIcon21 />
                  </span>
