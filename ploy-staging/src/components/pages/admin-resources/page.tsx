            ...
            <div className="max-w-6xl mx-auto pt-8 pb-24 max-md:px-4 md:max-lg:px-6 lg:px-10">
              ...
              <div className="mt-8">
                <div>
                  ...
                  <div className="border-solid border-ploy-neutral-primary-s3 bg-ploy-background-secondary grid gap-3 mt-6 p-6 rounded-3xl sm:grid-cols-2 md:grid-cols-[repeat(2,minmax(0px,1fr))] border">
                    <input
                      placeholder="Title"
                      style={{ fontVariationSettings: "inherit" }}
                      className="border-solid border-ploy-neutral-primary-s3 [color:inherit] bg-ploy-background-primary [font-weight:inherit] block px-4 py-2 rounded-[1.25rem] overflow-clip border"
                    />
                    <input
                      placeholder="URL"
                      style={{ fontVariationSettings: "inherit" }}
